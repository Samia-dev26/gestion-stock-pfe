c:\xampp1\htdocs\projet_laravel\projet_laravel\resources\views\products<!DOCTYPE html>
<html
  lang="fr"
...
>
  <head>
    ...
    <title>@yield('title', 'StockPro - Dashboard') | Sneat</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('dashboard') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">StockPro</span>
            </a>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/products" class="menu-link">
                    <div data-i18n="List">Liste</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/products/create" class="menu-link">
                    <div data-i18n="Create">Ajouter</div>
                  </a>
                </li>
              </ul>
            </li>
...
<a href="/categories" class="menu-link">
            ...
            <!-- Mouvements -->
            <li class="menu-item {{ request()->routeIs('mouvements*') ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-git-merge"></i>
                <div data-i18n="Movements">Mouvements</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('mouvements.index') }}" class="menu-link">
                    <div data-i18n="List">Historique</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <!-- Décharges -->
            <li class="menu-item {{ request()->routeIs('decharges*') ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-trash"></i>
                <div data-i18n="Discharges">Décharges</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('decharges.index') }}" class="menu-link">
                    <div data-i18n="List">Historique</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('decharges.create') }}" class="menu-link">
                    <div data-i18n="Create">Nouvelle</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="{{ route('logout') }}" class="menu-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                ...
                <div data-i18n="Log Out">Déconnexion</div>
              </a>
        ...
        <div class="layout-page">
          <!-- Navbar -->
          @include('layouts.partials._sneat-navbar')
          <!-- / Navbar -->
